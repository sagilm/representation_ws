...
1. Represente los _boids_ del [FlockOfBoids](https://github.com/VisualComputing/frames/tree/master/examples/demos/FlockOfBoids) mediante superficies de spline.
